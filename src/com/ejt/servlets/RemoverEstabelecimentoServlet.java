...
/**
 * Servlet implementation class RemoverEstabelecimentoServlet
 */
@WebServlet("/RemoverEstabelecimentoServlet")
public class RemoverEstabelecimentoServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RemoverEstabelecimentoServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			fachada.estabelecimentoRemoverId(id);
			...
			RequestDispatcher rd = request.getRequestDispatcher("RemoverEstabelecimentoServlet");
